...
<body>
    ...
    <header class='header'>
        ...
        <div class="sub">
            <div class="box">
                ...
                <a href="/member1" id="dash">Dashboard</a>
    ...
    <div class="planet2 a1">
        <img class="planet1 " src="/images/mars.png" alt="">
        <div class="dis">
            <h2>Planet</h2>
            <p>Mars is the fourth planet and the furthest terrestrial planet from the Sun. The reddish color of its surface
                is due
                to
                finely grained iron(III) oxide dust in the soil, giving it the nickname "the Red Planet". Mars's radius is
                second
                smallest among the planets in the Solar System at 3,389.5 km.</p>
        </div>
    </div>
