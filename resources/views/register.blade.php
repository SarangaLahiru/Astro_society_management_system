...
<body>
    <div class="box">
        ...
        <form action="{{route('reg')}}" method='POST'>
            ...
            @csrf
            <div class="frm-g">
                <input type="text" name="name" class="form-control{{($errors->first('name') ? " form-error" : "")}}"  placeholder="Username">
                @if($errors->has('name'))
                <span>
            ...
            <p id="a1">If you already have an account <a href="/login2">Sign in</a></p>
            <div class="frm-g">
